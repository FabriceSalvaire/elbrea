...
#
# http://intranet/redmine-it/public/projects/Elbrea.xml
# <project>
#   <id>1</id>
#   <name>Elbrea</name>
#   <identifier>elbrea</identifier>
#   <description/>
#   <homepage/>
...
# ...
#
# http://intranet/redmine-it/public/projects/Elbrea/issues.xml
# 
####################################################################################################
...
if __name__ == '__main__':
    ...
    elbrea_project = redmine_rest.get_project('Elbrea')

    print(redmine_rest.get_issue(173))

    if False:
        elbrea_project.new_issue(subject='This a test!',
